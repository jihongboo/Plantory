...
Each `imageFileName` points to a transparent-background pixel plant PNG in `images/`. Upload that PNG to the CloudKit `image` Asset field for the matching record.
